...
from sqlalchemy import String, Float, DateTime, JSON, Enum as SAEnum, UniqueConstraint
...
class RiskScore(Base):
    ...
    location_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), nullable=True, index=True)
